export default function Principal(){
  return (
    <div className="mx-3 my-28 md:mx-28 md:my-14 lg:mx-52 xl:mx-64">
     <h1 className=" text-gray-300 text-base font-medium">OLÁ, EU SOU O <br/>
         <span className=" text-white font-semibold text-5xl ">João <span className="">Augusto..</span></span></h1>
      <h3 className=" mt-2 text-lg font-light">Desenvolvedor de Software | Estudante <br/> de Ciências da Computação.</h3>
      <div className=" mt-5 w-full bg-color-black-sidebar border border-stone-900 p-3">
