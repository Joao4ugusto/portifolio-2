...
export default function Principal(){
  return (
    <div className=" z-30 mx-4 my-28 md:mx-10 md:my-14 lg:mx-96 xl:ml-[530px] xl:mx-[310px] md:absolute">
     ...
     <h1 className=" italic text-slate-200 text-lg font-medium">OLÁ, EU SOU O <br/>
      ...
      <div className="flex flex-wrap mt-12 gap-y-6 gap-x-2 justify-between">
