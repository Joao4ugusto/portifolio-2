...
export default function Principal(){
  return (
    ...
    <div className=" z-30 mx-5 my-28 md:my-28 lg:my-14 md:mx-[55px] md:ml-[330px]  lg:mx-[100px] lg:ml-[400px] xl:ml-[520px] xl:mx-[240px] 2xl:ml-[565px]  2xl:mx-[300px] md:absolute">
      ...
      <div className=" cursor-pointer py-2 px-3 bg-color-black-sidebar border rounded border-stone-800 text-center"><a href="/projetos" className=" font-normal">Projetos</a></div>
      ...
      <div className="cursor-pointer flex items-center">
       <h1 className=" ml-2 font-normal"> E-mail</h1>
      </div>
      </div>
      </a>
      </button>
      ...
      <div className=" lg:mb-10 xl:mb-8 hover:bg-color-black-sidebar/50 mt-8 w-full bg-color-black-sidebar border border-stone-800 rounded p-4">
