export default function Principal(){
  return (
    <div className="mx-3 my-28 md:mx-28 md:my-14 lg:mx-52 xl:mx-64">
     <h1 className="text-white text-base font-medium">Olá, eu sou o <br/>
         <span className=" font-semibold text-5xl">João Augusto<i className=" text-rose-950">..</i></span></h1>
      <h3 className=" mt-2 text-lg font-normal">Desenvolvedor de Software | Estudante <br/> de Ciências da Computação.</h3>
