  ...
  return (
    <div className="mx-3 my-32 md:mx-28 md:my-14 lg:mx-52 xl:mx-64">
     <h1 className=" text-gray-300 text-base font-medium">OLÁ, EU SOU O <br/>
         <span className=" text-white font-semibold text-5xl ">João <span className=" font-semibold bg-gradient-to-br from-pink-600 to-orange-500 text-transparent bg-clip-text">Augusto..</span></span></h1>
