...
export default function Principal(){
  return (
    <div className=" z-30 mx-4 my-28 md:mx-10 md:my-14 lg:mx-96 xl:mx-96 md:absolute">
      <div className="absolute right-6 text-cyan-500 rotating-icon animate-spin duration-400"><IconReact  width={32} height={32}/></div>
  ...
  <div className="flex items-center">
    E-mail
      ...
      <h3 className=" mt-10 text-base underline italic">TECNOLOGIAS</h3>
      ...
      <div className="   transition-transform duration-500 transform hover:-translate-y-3 p-5  w-16 h-16 bg-color-black-sidebar border border-stone-800 rounded"><IconBxlSass  width={24} height={24} /></div>
        ...
        <div className=" transition-transform duration-500 transform hover:-translate-y-3 p-5  w-16 h-16 bg-color-black-sidebar border border-stone-800 rounded"><IconBxlPostgresql width={24} height={24}  /></div>
      </div>
    </div>
  )
}