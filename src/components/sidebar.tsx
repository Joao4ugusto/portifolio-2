...
export default function Sidebar({open, onClose, children}: props){
  return(
    <section className={`z-50 transition-all duration-400 fixed  left-0 top-0 bottom-0 text-white border-r-2 border-stone-900 ${open ? ' w-screen bg-color-black-sidebar' : 'w-0'} md:w-[260px]  md:bg-color-black-sidebar`} >
