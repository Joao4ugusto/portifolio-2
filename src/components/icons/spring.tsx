// icon:bxl-spring-boot | Boxicons https://boxicons.com/ | Atisa
import * as React from "react";

function IconBxlSpringBoot(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
